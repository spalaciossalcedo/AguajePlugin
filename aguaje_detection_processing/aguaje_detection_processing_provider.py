...
from .aguaje_detection_processing_algorithm import AguajeDetectionAlgorithm


class AguajeDetectionProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(AguajeDetectionAlgorithm())
